...
class ExpertAppointmentDetailsSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isExpert) {
      ...
      statusColor = isConfirmed
          ? const Color(0xFF66BB6A)
          : const Color(0xFFFFA726); // Orange for waiting
      statusBg = isConfirmed
          ? const Color(0xFFE8F5E9)
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Action Buttons
            if (isExpert)
              _buildExpertActions(context, isConfirmed, appointment.dateTime)
            else
              _buildClientActions(context, isConfirmed, appointment.dateTime),
